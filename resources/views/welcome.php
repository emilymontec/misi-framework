  ...
  <style>
    ...
    * {
    ...
    @media (max-width: 992px) {
      ...
      .install-grid, .example-grid { grid-template-columns: 1fr; }
      ...
      .cube-field { overflow: hidden; border-radius: inherit; }
    ...
    @media (max-width: 768px) {
      ...
      .logo-item { border-bottom: 1px solid var(--border-color); }
      .logo-item:nth-child(3n) { border-right: none; }
      .logo-item:nth-last-child(-n+3) { border-bottom: none; }
      .cards-grid { grid-template-columns: 1fr; }
      .section-title { font-size: 1.9rem; }
      .live-demos-bar { flex-direction: column; align-items: flex-start; }
    }
    ...
    @media (max-width: 480px) {
      .hero-banner { padding: 20px 20px 24px; }
      ...
      <div class="hero-right">
        ...
        <div class="quick-install-box">
          <div class="quick-install-code" id="quickInstallCode">
            <span>$</span> curl -fsSL https://raw.githubusercontent.com/TU_USUARIO/misi-framework/main/install.sh | sh
          </div>
          <button class="btn-copy-quick" id="btnCopyQuick" data-copy="curl -fsSL https://raw.githubusercontent.com/TU_USUARIO/misi-framework/main/install.sh | sh">
